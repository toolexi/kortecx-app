      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className=" items-center font-bold justify-center text-center bg-black bg-opacity-80 px-8 py-6 rounded-lg shadow-lg text-white">
          ...
          <button>
            <a
              href="/homepage"
              className=" items-center justify-center text-center bg-orange-500 text-white px-4 py-2 rounded-md hover:bg-orange-600 transition-colors"
            >
              Start Building
            </a>
          </button>
